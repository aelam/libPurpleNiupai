...
// */
extern int NIDebugAssertionsShouldBreak;
//
///**
...
// */
#ifdef DEBUG
#define NIDPRINT(xx, ...)  fprintf(stdout,"%s:%s[%d]:" xx,__TIME__, __PRETTY_FUNCTION__, __LINE__, ##__VA_ARGS__)
#else
